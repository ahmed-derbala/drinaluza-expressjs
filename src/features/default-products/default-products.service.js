...
export const createDefaultProductSrvc = async ({ name, slug, media, searchKeywords, price, unit, specs }) => {
	if (!slug) {
	...
	return createDefaultProductRepo({ name, slug, media, searchKeywords, price, unit, specs })
}
